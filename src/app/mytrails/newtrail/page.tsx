        ...
        {!isFormVisible ? (
          <div className="w-full">
            ...
            <div className="flex flex-wrap justify-center sm:justify-between mt-8 gap-4">
              {!isTracking || isPaused ? (
                <button
                  onClick={handleStart}
                  className="bg-green-700 p-3 sm:p-4 rounded-full shadow-md text-white flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 hover:bg-green-800"
                >
          ...
          >
            <div className="mb-4">
              <label
                htmlFor="name"
                className="block text-base md:text-lg font-medium text-gray-800"
              >
                Nome da Atividade
              </label>
              <input
                ...
                required
                className="mt-1 block w-full p-2 bg-white border border-green-600 rounded"
              />
            </div>
            <div className="mb-4">
              <label
            ...
            <div className="flex flex-col sm:flex-row justify-center sm:justify-between mt-6 gap-4">
              ...
              <button
                type="submit"
                className="bg-green-700 text-white p-2 sm:p-3 rounded-full w-full sm:w-1/2 hover:bg-green-800"
              >
                Salvar Atividade
              </button>
            </div>
